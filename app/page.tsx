    ...
    <main>
      ...
      <div className="container">
        <section className="hero">
          ...
          <div className="heroCard experienceDemo">
            <div className="demoTop"><span className="liveDot">●</span> QR DINÂMICO</div>
            <div className="demoQr">▦</div>
            <h2>Um código. Infinitas possibilidades.</h2>
            <p className="muted">Hoje uma homenagem. Amanhã um vídeo. Depois uma promoção. Você altera o destino sem reimprimir o QR.</p>
          </div>
        </section>
        ...
        <section className="section businessBand">
          <div><span className="eyebrow">nova fonte de receita</span><h2>Você personaliza produtos? Venda também a experiência.</h2><p className="lead">Gráficas, lojas de presentes, fotógrafos, agências e personalizadores podem criar QRs para seus clientes, aplicar sua própria margem e administrar tudo em um único painel.</p></div>
          <Link href="/revender" className="button">Conhecer plano Revendedor</Link>
        </section>

        <section className="section centerCta">
          <h2>O primeiro QR é por nossa conta.</h2>
          <p className="lead">Crie uma experiência simples gratuitamente e descubra o que um QR pode fazer pelo seu presente, produto ou campanha.</p>
